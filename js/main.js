...
class WineListApp {
    ...
    updateMetaInfo(wine) {
        ...
        const alcoholRaw = wine.alcohol ? String(wine.alcohol).trim() : '';
        const alcohol = alcoholRaw ? (alcoholRaw.endsWith('%') ? alcoholRaw : `${alcoholRaw}%`) : 'N/A';
    ...
    getWineLabDefaults(wine) {
        ...
        return {
            ...
            vintageSpec: vintage,
            alcohol: (() => { const a = wine.alcohol ? String(wine.alcohol).trim() : ''; return a ? (a.endsWith('%') ? a : `${a}%`) : 'N/A'; })(),
